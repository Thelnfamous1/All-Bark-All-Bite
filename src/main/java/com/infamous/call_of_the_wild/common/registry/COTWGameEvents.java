...
public class COTWGameEvents {

    public static DeferredRegister<GameEvent> GAME_EVENTS = DeferredRegister.create(Registry.GAME_EVENT_REGISTRY, CallOfTheWild.MODID);
